...
The focus of the first part of the thesis is on lifeycle changes events. In particular, the problem of lifecycle handling is addressed first with a static code analysis approach to recognize possible misuses of components, and then with a dynamic approach that allows the developer to drive the application lifecycle to test its robustness.\bigskip \\
...
The following image\footnote{https://developer.android.com/training/basics/activity-lifecycle/starting.html\#lifecycle-states} shows a simplified scheme of the Activity lifecycle transitions with the corresponding Java callbacks.
...
The following image\footnote{https://developer.android.com/guide/components/fragments.html\#Creating} shows the main Fragment callbacks:
