...
\forall e1 \bigg( match(e1, m1) \Rightarrow \exists e2 \Big( match(e2, m2) \land before(e2, e1) \Big) \bigg)
  ...
  \rotatebox[origin=c]{90}{\textbf{ Visual }} & 
	...
	\raisebox{-230pt}{\includegraphics[width=400px]{Images/Event/Lang/CanHappenOnlyAfter.png}}
...
\begin{longtable}{ | m{0.3cm} | m{15cm} | }
  ...
  \rotatebox[origin=c]{90}{\textbf{ Visual }} & 
	...
	\raisebox{-280pt}{\includegraphics[width=400px]{Images/Event/Lang/MustHappenAfter.png}}
...
\begin{longtable}{ | m{0.3cm} | m{15cm} | }
  ...
  \rotatebox[origin=c]{90}{\textbf{ Visual }} & 
	...
	\raisebox{-105pt}{\includegraphics[width=400px]{Images/Event/Lang/AllHold.png}}
