...
\begin{itemize}
	...
	\item Part \ref{part_motivation} introduces the idea of events and event-based testing, as well as a more detailed outline of the achieved results
...
\part{Motivation}\label{part_motivation}
